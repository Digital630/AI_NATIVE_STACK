...
const ReadinessCheckSection = () => {
  return (
    <section id="readiness-check" className="py-16 md:py-20 bg-muted/30">
      <div className="container mx-auto px-4 max-w-2xl">
        <div className="bg-card border border-border rounded-lg p-8 md:p-10 shadow-sm text-center">
          ...
          <p className="text-muted-foreground text-sm md:text-base mb-8 max-w-lg mx-auto">
            Readiness is contextual. This pathway routes you into a live assessment with Alex to clarify documentation, capacity, and market fit.
          </p>
...
export default ReadinessCheckSection;
